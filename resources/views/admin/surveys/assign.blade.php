<x-admin-layout>
    <div class="container-fluid py-4">
        <div class="d-sm-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0 text-gray-800">Assign Users to Surveys</h1>
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">{{ $survey->name }}</h6>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('admin.surveys.assignUsers', $survey->id) }}">
                    @csrf
                    <div class="mb-3">
