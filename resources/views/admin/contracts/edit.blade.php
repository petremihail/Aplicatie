<x-admin-layout>
    <div class="container-fluid py-4">
        <div class="d-sm-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit Contract</h1>
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.contracts.update', $contract->id) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('terms') is-invalid @enderror" id="terms" name="terms" rows="5">{{ old('terms', $contract->terms) }}</textarea>
                        @error('terms')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
