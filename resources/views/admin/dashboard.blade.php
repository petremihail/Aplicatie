                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                                    Tasks</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $pendingTaskCount }}</div>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                    Surveys</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $surveyCount }}</div>
                            </div>
                            <div class="col-auto">
                            ...
                            <table class="table table-bordered" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($task->priority)
                                                <span class="badge {{ $task->priority->name == 'High' ? 'bg-danger' : ($task->priority->name == 'Medium' ? 'bg-warning' : 'bg-success') }}">
                                                    {{ $task->priority->name }}
                                                </span>
                                            @else
