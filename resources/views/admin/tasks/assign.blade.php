<x-admin-layout>
    <div class="container-fluid py-4">
        <div class="d-sm-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0 text-gray-800">Assign Users to Task</h1>
            <a href="{{ route('admin.tasks.show', $task->id) }}" class="btn btn-secondary">
                <i class="fas fa-arrow-left fa-sm"></i> Back to Task
            </a>
        </div>
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.tasks.assignUsers', $task->id) }}">
                    @csrf
                    <div class="mb-3">
